...
- Local tests: 337 passed, zero failed, one SQL integration test skipped without its dedicated database.
...
1. Exact candidate SHA CI green, independent review of OAuth/identity and authorization. Review identity creation concurrency/partial-write handling in the inherited v3 code before enabling real signup.
